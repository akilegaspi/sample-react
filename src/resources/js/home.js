...
$(document).ready(function(){
  ...
  $(".sauceink-explore").click(function(){
    ...
    [
      ...
      '<div class="sauceink-explore-vid"><div><video autoplay loop muted><source src="vid/placeholder-video.mp4" type="video/mp4">Your browser does not support the video tag.</video></div></div>',
